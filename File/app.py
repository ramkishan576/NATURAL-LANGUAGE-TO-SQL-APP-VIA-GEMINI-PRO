...
# Prompt template to guide Gemini in converting natural language to SQL
prompt = [
    """
...
st.title("🔍 Natural Language to SQL with Gemini Pro")

# User input for English question
question = st.text_input("Ask a question about the STUDENT database:", key="input")

# Button to submit the query
submit = st.button("Get my answer..")

# When the button is clicked
if submit:
    with st.spinner("Cooking your SQL answer... 🍳"):
        ...
        if sql_query:
            ...
            if result:
                ...
                st.warning("⚠️ No results found or an error occurred.")
